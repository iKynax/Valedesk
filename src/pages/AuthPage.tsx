              ...
              <TabsContent value="signin" className="mt-0">
                <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 10 }}>
                  ...
                  <div className="mt-8 flex items-center gap-4 text-[10px] font-black uppercase tracking-widest text-[#061B3A]/35 before:h-px before:flex-1 before:bg-sky-100 after:h-px after:flex-1 after:bg-sky-100">
                    ...
                    <Button type="button" disabled={!configured} onClick={google} variant="outline" className="mt-8 flex h-14 w-full items-center gap-3 rounded-full border-sky-200 text-xs font-black uppercase tracking-widest text-[#061B3A] hover:bg-sky-50">
